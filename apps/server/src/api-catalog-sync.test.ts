...
const IMPLEMENTED_ROUTES: Array<{ method: string; path: string }> = [
  ...
  { method: "GET", path: "/api/system/persistence/health" },
  { method: "GET", path: "/api/system/persistence/backups" },
  { method: "POST", path: "/api/system/persistence/backup" },
  { method: "POST", path: "/api/system/persistence/export" },
  { method: "POST", path: "/api/system/persistence/import" },
  { method: "POST", path: "/api/system/persistence/factory-reset" },
  { method: "POST", path: "/api/system/persistence/prune" },
  { method: "POST", path: "/api/system/persistence/vacuum" },
