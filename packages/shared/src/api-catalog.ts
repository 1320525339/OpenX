...
export const OPENX_API_CATALOG: readonly ApiEndpointDef[] = [
  ...
  { id: "conversations_forget", method: "POST", path: "/api/conversations/:id/forget", category: "conversations", summary: "遗忘对话（清空线程或删除会话壳）", auth: "none", pathParams: ["id"], bodyHint: '{ level: "clear_thread" | "delete_conversation" }' },
  { id: "conversations_delete", method: "DELETE", path: "/api/conversations/:id", category: "conversations", summary: "删除对话（保留任务，迁入保管箱）", auth: "none", pathParams: ["id"] },
  { id: "projects_forget_conversations", method: "POST", path: "/api/projects/:id/forget-conversations", category: "projects", summary: "遗忘项目下全部对话", auth: "none", pathParams: ["id"] },
